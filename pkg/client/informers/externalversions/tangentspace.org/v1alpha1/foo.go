...
import (
	...
	tangentspaceorgv1alpha1 "github.com/tangentspace/terrazzo/pkg/apis/tangentspace.org/v1alpha1"
	versioned "github.com/tangentspace/terrazzo/pkg/client/clientset/versioned"
	internalinterfaces "github.com/tangentspace/terrazzo/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tangentspace/terrazzo/pkg/client/listers/tangentspace.org/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TerraformV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TerraformV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&tangentspaceorgv1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tangentspaceorgv1alpha1.Foo{}, f.defaultInformer)
}
