...
type FakeFoos struct {
	Fake *FakeTerraformV1alpha1
	ns   string
}

var foosResource = schema.GroupVersionResource{Group: "terraform.tangentspace.org", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "terraform.tangentspace.org", Version: "v1alpha1", Kind: "Foo"}
